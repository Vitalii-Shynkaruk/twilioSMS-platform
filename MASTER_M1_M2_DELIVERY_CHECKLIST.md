...
| M1.1 — Passwordless OTP Login/Auth              |      10% |       9.8% | Live SMS OTP + browser redirect/current-user passed; SMTP settings/email-code UI deployed; production email delivery smoke still blocked until server SMTP relay or external SMTP credentials are confirmed |
